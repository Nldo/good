...
def get_args():
    ...
    parser.add_argument('--checkpoint_root', default='checkpoints/MMLEVIRX8', type=str)
    parser.add_argument('--output_folder', default='samples/MMLEVIRX8', type=str)
    ...
    parser.add_argument('--net_G', default='mmNet8_fsr', type=str,
