...
class CDDataAugmentation:
    ...
    def transform(self, imgs, labels, to_tensor=True):
        ...
        #     imgsize0 = imgs[0].size
        #     imgsize = imgs[1].size
        #     # crop
        #     box0 = get_random_crop_box(imgsize=imgsize0, cropsize=64)
        #     box = get_random_crop_box(imgsize=imgsize, cropsize=self.img_size)
        #     imgs = [pil_crop(imgs[0], box0, cropsize=64, default_value=0),
        #             pil_crop(imgs[1], box, cropsize=self.img_size, default_value=0)
        #             ]
        #
        #      # h, w
        #     box = get_random_crop_box(imgsize=imgsize, cropsize=self.img_size)
